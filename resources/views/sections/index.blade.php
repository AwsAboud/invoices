...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الاقسام</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <div class="card">
                            ...
                            <div class="row row-sm mt-3 mr-2 ">
                                <div class="col-sm-6 col-md-4 col-xl-3 ">
                                    <a class="modal-effect btn btn-outline-primary btn-block text-lg" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8" >اضافة&nbsp; قسم </a>
                                </div>

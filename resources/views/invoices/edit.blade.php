        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('invoices.update', ['invoice' => $invoice->id]) }}" method="post" autocomplete="off">
                        @method('PATCH')
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="collection_amount"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="commission_amount"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value="{{ $invoice->commission_amount }}" required>
                            </div>
    ...
    <script>
        function myFunction() {
            ...
            if (typeof commission_amount === 'undefined' || !commission_amount) {
                ...
                var intResults = commission_amount2 * rate_vat / 100;

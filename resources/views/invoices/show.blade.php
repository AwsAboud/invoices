                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($invoice_details as $invoice_details)
                                                            <tr>
                                                                ...
                                                                <td>{{ $invoice_details->created_by }}</td>
                                                            ...
                                                            @foreach ($attachments as $attachment)
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <a class="btn btn-outline-success btn-sm"
                                                                        href="{{ url('view-invoice-file') }}/{{ $invoice->invoice_number }}/{{ $attachment->file_name }}"
                                                                        role="button" target="_blank"><i
                                                                            class="fas fa-eye"></i>&nbsp;
                                                                        عرض</a>

                                                                    <a class="btn btn-outline-info btn-sm"
                                                                        href="{{ url('dawnload-invoice-file') }}/{{ $invoice->invoice_number }}/{{ $attachment->file_name }}"
                                                                        role="button" target="_blank"><i

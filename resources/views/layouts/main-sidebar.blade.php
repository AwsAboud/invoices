        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . $page='invoices/not-paid') }}">الفواتير الغير مدفوعة</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='invoices/partial-paid') }}">الفواتير المدفوعة جزئيا</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='invoices/archive') }}">أرشيف الفواتير</a></li>
                </ul>
            </li>
